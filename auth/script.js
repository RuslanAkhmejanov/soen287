...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (currentPage === '/auth/signin.html') {
    ...
    } else if (currentPage === '/auth/signup.html') {
...
function displayPassword(password, passwordConfirmation, eyeIcon) {
    ...
    eyeIcon.addEventListener('click', () => {
        if (password.type === 'password') {
            password.type = 'text';
            eyeIcon.src = '../public/assets/show-icon.svg'
            ...
            eyeIcon.src = '../public/assets/hide-icon.svg'
...
function validateSignUpForm(name, username, password, passwordConfirmation, usersDB) {
